...
export function VenueHero({
  ...
  return (
    <section className="relative overflow-hidden pb-10 pt-8 sm:pb-14 sm:pt-10 md:pb-16 md:pt-12">
      ...
      <div className="bobsonm-container relative grid items-start gap-8 py-8 md:grid-cols-[minmax(0,0.92fr)_minmax(320px,0.88fr)] md:gap-12 md:py-12">
        <div className="order-2 flex max-w-2xl flex-col md:order-1">
          <FadeUp>
